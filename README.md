...
### Kalil Nege · Back-End Engineer & AI Developer
...
IA / ML   ████████████░░░░░░░░  Python · PyTorch · HuggingFace · BERTimbau
...
Modelo **BERTimbau** fine-tuned com **187k reviews reais** do Mercado Livre. Pipeline completo de NLP com 95% de acurácia, API FastAPI e deploy no Hugging Face Spaces.

`Python` `PyTorch` `HuggingFace` `FastAPI` `Docker` `BERTimbau`

[![Demo](https://img.shields.io/badge/Demo_ao_vivo-00e5a0?style=flat-square)](https://huggingface.co/spaces/kalilzera/ReviewCheckIA)
[![Repo](https://img.shields.io/badge/Repositório-181717?style=flat-square&logo=github)](https://github.com/kalil03/ReviewCheckIA)
...
### 🔍 DeepFakes Detection
> Detecção de deepfakes com Deep Learning + ML clássico
